...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-purchase_discount',
    download_url='https://github.com:nantic/trytond-purchase_discount.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-purchase_discount.git'
    },
    classifiers=[
